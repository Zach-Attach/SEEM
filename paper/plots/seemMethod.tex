\begin{figure*}
  ...
  The boundaries are calculated as a range from the minimum coordinate - $\varepsilon$ to the maximum coordinate - $\varepsilon$ for each dimension ($x$,$y$,$z$). $\varepsilon$ is defined as the width of a neurite (3 µm). 
  ...
  A random subset of these potential connections are chosen equal to the number of total connections found in the \ce network to which it is being compared.}
\end{figure*}